...
class LinksPage(Resource):
    def get(self):
        data = read_file('C:/Users/Hp/ProgramnowanieCwiczenia/pythonProject/lab_7/links.csv')
        links = list()
        for x in data:
...
class RatingsPage(Resource):
    def get(self):
        data = read_file('C:/Users/Hp/ProgramnowanieCwiczenia/pythonProject/lab_7/ratings.csv')
        ratings = list()
        for x in data:
...
class TagsPage(Resource):
    def get(self):
        data = read_file('C:/Users/Hp/ProgramnowanieCwiczenia/pythonProject/lab_7/tags.csv')
        tags = list()
        for x in data:
